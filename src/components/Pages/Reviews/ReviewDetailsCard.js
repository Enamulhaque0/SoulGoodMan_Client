...
const ReviewDetailsCard = ({review}) => {
  ...
  const {reviewText,userInfo,  }= review
  ...
  const {name,photo}= userInfo
    ...
    <div className="mb-12 md:mb-0">
        <div className="flex justify-center mb-6">
          <img src={photo?photo: "N/A"} className="rounded-full shadow-lg w-32" />
        </div>
       
        <h6 className="font-medium text-blue-600 mb-4">{name? name: "Unknown Person"}</h6>
        <p className="mb-4">
